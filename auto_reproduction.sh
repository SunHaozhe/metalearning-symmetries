...
python train_synthetic.py --problem 2d_rot4 --model share_fc
python train_synthetic.py --problem rank2_kernel5 --model share_fc
python train_synthetic.py --problem rank5_kernel5 --model share_fc
...
python train_synthetic.py --problem 2d_rot4 --model share_conv
